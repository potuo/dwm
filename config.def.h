...
static const char *fonts[]          = {
  ...
  "Source Han Sans CN:size=10",      // 换成思源黑体，并给到 16
...
static const char *fonts[]               = { 
  "JetBrainsMono Nerd Font Mono:style=medium:size=12",
  "monospace:size=12",
  "WenQuanYi Zen Hei Mono:size=10"
};
 static const char *fonts[]               = { "JetBrainsMono Nerd Font Mono:style=medium:size=13", "monospace:size=11" }; */
...
static const char *tags[] = { 
    "乙", // tag:0  key:1  desc:terminal1
    "丙", // tag:1  key:2  desc:terminal2
    "丁", // tag:2  key:3  desc:terminal3
    "戊", // tag:4  key:9  desc:obs
    "己", // tag:5  key:c  desc:chrome
    "庚", // tag:6  key:m  desc:music
    "辛", // tag:7  key:0  desc:qq
    "壬", // tag:8  key:w  desc:wechat
    "癸", // tag:9  key:l  desc:wxwork
};
...
static const Rule rules[] = {
    ...
    /** 普通优先度 */
    {"obs",                  NULL,                 NULL,             0,        0,          0,          0,        -1,      0}, // obs        tag -> 󰕧
    {"chrome",               NULL,                 NULL,             0,            0,          0,          0,        -1,      0}, // chrome     tag -> 
    {"Chromium",             NULL,                 NULL,             0,            0,          0,          0,        -1,      0}, // Chromium   tag -> 
    {"music",                NULL,                 NULL,             0,            1,          0,          1,        -1,      0}, // music      tag ->  浮动、无边框
    { "QQ",                  NULL,                 NULL,             0,            1,          0,          1,        -1,      0}, // qq         tag -> ﬄ 无边框
    { "wechat",              NULL,                 NULL,             0,            1,          0,          1,        -1,      0}, // wechat     tag -> ﬐ 无边框
    { "com.alibabainc.dingtalk",              NULL,                 NULL,             0,            1,          0,          1,        -1,      0}, // wechat     tag -> ﬐ 无边框
    { NULL,                 "wxwork.exe",          NULL,             0,            0,          0,          1,        -1,      0}, // workwechat tag ->  无边框
...
static Key keys[] = {
    ...
    { MODKEY,              XK_0,            previewallwin,    {0} },                     /* super 0            |  overview */
